 ...
 * PIDOutput
 */
public class ModifiedPIDController/* implements IUtility, LiveWindowSendable, Controller*/ {
    ...
    DataCommunicator m_pidInput;
    DataCommunicator m_pidOutput;
    ...
    private class PIDTask extends TimerTask {
        ...
        private ModifiedPIDController m_controller;

        public PIDTask(ModifiedPIDController controller) {
            if (controller == null) {
     ...
     */
    public ModifiedPIDController(double Kp, double Ki, double Kd, double Kf,
    		DataCommunicator source, DataCommunicator output,
            double period) {
     ...
     * @param period 
     */
    public ModifiedPIDController(double Kp, double Ki, double Kd,
    		DataCommunicator source, DataCommunicator output,
            double period) {
    ...
    private void calculate() {
        ...
        if (enabled) {
            double input = pidInput.getDataPoint();
            double result;
            DataCommunicator pidOutput = null;
    ...
    public synchronized double getError() {
        //return m_error;
        return getSetpoint() - m_pidInput.getDataPoint();
    }
